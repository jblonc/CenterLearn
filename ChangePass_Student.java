/*
 * ChangePass_Student.java
 *
 * Created on July 7, 2005, 2:10 PM
 */
...
public class ChangePass_Student extends HttpServlet {
    ...
    throws ServletException, IOException {
       ...
       // String tutors_ta=(String)session.getAttribute("tutors_ta");
        ...
        out.println("<FORM METHOD=\"POST\" ACTION=\"Tutee.jsp \">");  
       ...
       try{
           Class.forName(driver);
                ...
                String query_INF="SELECT password FROM "+tutees_ta+" WHERE username ='"+username+"'";
       ...
       Matcher m_letter=p_letter.matcher(npassword);
        ...
        if(!usernamet.equals(username)){PasswordChangeStatusMessage="<font color=red>Failure</font>: you're not allowed to change your username.";}
            ...
            try{
                ...
                String qry="UPDATE "+tutees_ta+" SET password='"+npassword+"' WHERE username ='"+username+"'";
